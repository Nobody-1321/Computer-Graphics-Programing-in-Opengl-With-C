...
void init(GLFWwindow* window) {
    ...
    raytraceComputeShader = Utils::createShaderProgramCP("shaders/compute_shader168.glsl");
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "program_16_8", nullptr, nullptr);
    if (!window) {

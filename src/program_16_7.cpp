...
void init(GLFWwindow* window) {
    ...
    raytraceComputeShader = Utils::createShaderProgramCP("shaders/compute_shader167.glsl");
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "program_16_7", nullptr, nullptr);
    if (!window) {
